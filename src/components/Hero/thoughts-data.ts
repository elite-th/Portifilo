...
export const THOUGHTS: Thought[] = [
  ...
  },
  {
    ...
    refined:
      "Mind 2.0: بازآرایی دانش. یادداشتی که فاقد غایت (خروجی) و خاستگاه (منبع) باشد، تنها نویز است، نه آگاهی.",
    label: "#mind2.0",
  ...
  },
  {
    ...
    refined:
      "کدنویسی، هرموتیکِ مدرن است. دیالکتیکِ هگل و ساختارگراییِ فوکو، بنیادی‌ترین الگوریتم‌ها برای درک و معماری جهان دیجیتال هستند.",
  ...
  },
  {
    ...
    refined:
      "خلاقیتِ شبانه‌روزی. ایده‌ای که در ساعت ۰۲:۱۴ متولد می‌شود، اصیل‌ترین مواجهه‌ی ذهن با ناخودآگاه است؛ نباید اجازه داد در سپیده‌دم فراموش شود.",
    label: "#circadian",
  ...
  },
  {
    ...
    refined:
      "معماریِ تاب‌آور. در جهانی که اتصال (Connection) ناپایدار است، سیستم باید در انزوا (Offline) نیز حیات داشته باشد. تکنولوژی باید با واقعیتِ زیسته‌ی ما منطبق شود.",
    label: "#offline-first",
  ...
  },
  {
    ...
    refined:
      "زمان‌سنجِ خودآگاهی. این پورتفولیو نه برای نمایش، که برای رصدِ تطورِ فکری‌ست. ثبتِ این لحظه برای طاها در آینده.",
    label: "#meta",
