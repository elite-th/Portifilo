...
const WAYPOINTS: Waypoint[] = [
  {
    ...
    desc:
      "هر ابزاری که ساختم، اول برای خودم بوده. مشکلِ خودم، راه‌حلِ خودم. اگر برای خودم کار نکند، برای کسی کار نمی‌کند.",
  },
  {
    year: "۱۴۰۴",
    title: "از یادداشت به مقاله",
    desc:
      "یادداشت‌های پراکنده، مقاله می‌شوند. سخنرانی می‌شوند. روشِ کیمیاگری، از سکوت بیرون می‌آید.",
  },
  {
    year: "بعدش",
    title: "از tool-for-self به tool-for-many",
    desc:
      "ابزاری که برای خودم ساختم، برای کسانی که مثل من فکر می‌کنند. از یک آدم، به یک زیرساخت.",
  },
  {
    year: "∞",
    title: "شاگرد گرفتن",
    desc:
      "هر کیمیاگری روزی شاگرد می‌گیرد. اینجا دایره‌ی دانش بسته می‌شود — تا دوباره باز شود.",
  },
];
      ...
      <div className={styles.inner}>
        <header className={styles.sectionHeader}>
          ...
          <h2 id="go-title" className={styles.title} style={delay(120)}>
            یک خطِ زمانی که هنوز نوشته نمی‌شود — فقط زندگی می‌شود.
          </h2>
        </header>
