    ...
    >
      ...
      <div className={styles.inner}>
        ...
        <p className={styles.connectSub} style={delay(140)}>
          یک ایمیل بزن. یک issue باز کن. یک فکر بفرست. از هر کانالی که راحت‌تری.
          من همیشه جواب می‌دهم — شاید با تأخیرِ چند ساعته، اما همیشه.
        </p>
        ...
        <p className={styles.connectPostscript} style={delay(620)}>
          آن بالا گفتم «جایی که اندیشه، کالبد می‌یابد». حالا نوبتِ توست —
          بگذار اندیشه‌ات کالبد بگیرد.
        </p>
      </div>
    </section>
  );
